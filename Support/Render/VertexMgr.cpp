...
void vertex_mgr::DrawDList( xhandle hDList, D3DPRIMITIVETYPE PrimType )
{
    ...
    if( 0 )
    {
        ...
        {
            x_DebugMsg( "%f %f %f -- ", 
                pVert[ pIndx[ i * 3 + 0 ] - Vertex.Offset ].Pos.GetX(),
                pVert[ pIndx[ i * 3 + 0 ] - Vertex.Offset ].Pos.GetY(),
                pVert[ pIndx[ i * 3 + 0 ] - Vertex.Offset ].Pos.GetZ() );

            x_DebugMsg( "%f %f %f -- ", 
                pVert[ pIndx[ i * 3 + 1 ] - Vertex.Offset ].Pos.GetX(),
                pVert[ pIndx[ i * 3 + 1 ] - Vertex.Offset ].Pos.GetY(),
                pVert[ pIndx[ i * 3 + 1 ] - Vertex.Offset ].Pos.GetZ() );

            x_DebugMsg( "%f %f %f\n ", 
                pVert[ pIndx[ i * 3 + 2 ] - Vertex.Offset ].Pos.GetX(),
                pVert[ pIndx[ i * 3 + 2 ] - Vertex.Offset ].Pos.GetY(),
                pVert[ pIndx[ i * 3 + 2 ] - Vertex.Offset ].Pos.GetZ() );
