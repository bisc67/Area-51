...
static particle_def ParticleDefs[] =
{
    ...
    { "Particle Neck",
      0.0f, 0.0f, 252.0f,
      5.42604e-007f, 0.333638f, 160.384f,
      1.0f, 1.0f,
      true},
    ...
    { "Particle L Elbow",
      0.0f, 0.0f, 252.0f,
      28.2311f, 3.42739f, 123.779f,
      1.0f, 1.0f,
      true},

    { "Particle Head",
      0.0f, 0.0f, 252.0f,
      -0.0862226f, -7.94528e-006f, 181.767f,
      1.0f, 1.1f,
      true},

    { "Particle L Wrist",
      0.0f, 0.0f, 252.0f,
      35.7775f, 1.90027f, 98.0042f,
      1.0f, 0.9f,
      true},

    { "Particle R Wrist",
      0.0f, 0.0f, 252.0f,
      -35.7775f, 1.90017f, 98.0042f,
      1.0f, 0.9f,
      true},
...
{    
    ...
    SciDistRules,
    sizeof(SciDistRules) / sizeof(SciDistRules[0]),
    0,

    // Geometry bones (built at runtime)
    SciGeomBones,
    sizeof(SciGeomBones) / sizeof(SciGeomBones[0]),
    0,
