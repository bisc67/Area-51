...
CFG=StringMgr - Win32 Xbox Debug
...
!MESSAGE 
!MESSAGE NMAKE /f "StringMgr.mak" CFG="StringMgr - Win32 Xbox Debug"
!MESSAGE 
...
!MESSAGE "StringMgr - Win32 Xbox Debug" (based on "Win32 (x86) Static Library")
!MESSAGE "StringMgr - Win32 Xbox Release" (based on "Win32 (x86) Static Library")
!MESSAGE 
...
# ADD CPP /nologo /W3 /GX /O2 /I "$(X)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\..\support" /D "_LIB" /D "$(USERNAME)" /D "WIN32" /D "NDEBUG" /D "_MBCS" /YX /FD /c
...
# ADD CPP /nologo /W3 /Gm /GX /ZI /Od /I "$(X)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\..\support" /D "_LIB" /D "X_DEBUG" /D "X_ASSERT" /D "$(USERNAME)" /D "WIN32" /D "_DEBUG" /D "_MBCS" /YX /FD /GZ /c
...
!ELSEIF  "$(CFG)" == "StringMgr - Win32 Xbox Debug"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 1
# PROP BASE Output_Dir "StringMgr___Win32_Xbox_Debug"
# PROP BASE Intermediate_Dir "StringMgr___Win32_Xbox_Debug"
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 1
# PROP Output_Dir "Debug"
...
# PROP Target_Dir ""
LINK32=link.exe
# ADD BASE CPP /nologo /W3 /Gm /GX /ZI /Od /I "$(X)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\..\support" /D "WIN32" /D "_DEBUG" /D "_MBCS" /D "_LIB" /D "X_DEBUG" /D "X_ASSERT" /D "$(USERNAME)" /YX /FD /GZ /c
...
!ELSEIF  "$(CFG)" == "StringMgr - Win32 Xbox Release"

# PROP BASE Use_MFC 0
# PROP BASE Use_Debug_Libraries 0
# PROP BASE Output_Dir "StringMgr___Win32_Xbox_Release"
# PROP BASE Intermediate_Dir "StringMgr___Win32_Xbox_Release"
# PROP BASE Target_Dir ""
# PROP Use_MFC 0
# PROP Use_Debug_Libraries 0
# PROP Output_Dir "Release"
...
# PROP Target_Dir ""
LINK32=link.exe
# ADD BASE CPP /nologo /W3 /GX /O2 /I "$(X)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\..\support" /D "WIN32" /D "NDEBUG" /D "_MBCS" /D "_LIB" /D "$(USERNAME)" /YX /FD /c
# ADD CPP /nologo /G6 /W3 /GX /O2 /I "$(X)" /I "$(X)\x_files" /I "$(X)\Entropy" /I "$(X)\..\support" /D "TARGET_XBOX_DVD" /D "X_DEBUG" /D "X_ASSERT" /D "$(USERNAME)" /YX /FD /c
# ADD BASE RSC /l 0x409 /d "NDEBUG"
# ADD RSC /l 0x409 /d "NDEBUG"
BSC32=bscmake.exe
# ADD BASE BSC32 /nologo
...
# Name "StringMgr - Win32 Xbox Debug"
# Name "StringMgr - Win32 Xbox Release"
# Begin Source File
