...
public:
    enum soldier_attack_phases
    {
        ...
        PHASE_BO_ATTACK_EVADE_LEFT,
        PHASE_BO_ATTACK_EVADE_RIGHT,
    ...
    // Functions
public:
                    soldier_attack_state    ( character& ourCharacter, character_state::states State );
    virtual        ~soldier_attack_state    ( void );
...
protected:
    ...
    f32 m_TimeSinceLastRangeRethink;
