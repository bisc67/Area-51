...
static struct weapon_shotgun_desc : public object_desc
{

    weapon_shotgun_desc( void ) : object_desc( object::TYPE_WEAPON_SHOTGUN, 
                                        "Shotgun",
                                        "WEAPON",
...
} s_Weapon_Shotgun_Desc;

//=========================================================================

const object_desc&  weapon_shotgun::GetTypeDesc     ( void ) const
{
    return s_Weapon_Shotgun_Desc;
}

//=========================================================================

const object_desc&  weapon_shotgun::GetObjectType   ( void )
{
    return s_Weapon_Shotgun_Desc;
}
...
xbool weapon_shotgun::HasLOS( const vector3& A, const vector3& B )
{
...
void weapon_shotgun::HandleSweeperCone( const vector3& Pos,
...
xbool weapon_shotgun::FireWeaponProtected( const vector3& InitPos , const vector3& BaseVelocity, const f32& Power , const radian3& InitRot , const guid& Owner, s32 iFirePoint )
{
    (void)Power;
    (void)iFirePoint;
...
{   
    ...
    { 	
        ...
        FireBullet( InitPos, RandomRot, BaseVelocity, Owner, isHit, TRUE, PainHandle );
    }
...
void weapon_shotgun::GetPainHandle( pain_handle& OutHandle, guid Owner, xbool bIsPrimary )
{
...
void weapon_shotgun::FireBullet( const vector3& Pos, const radian3& Rot, const vector3& InheritedVelocity, guid Owner, const xbool bHitLiving, const xbool bIsPrimary, pain_handle& PainHandle )
{
    (void)bIsPrimary;
...
/*
    ...
    {
        BP->SetDamageAmount( g_MultiplayerPainTweaks.m_ShotgunDamage );
        BP->SetDamageDegradation( g_MultiplayerPainTweaks.m_ShotgunDistIncrement,
                                  g_MultiplayerPainTweaks.m_ShotgunLossPerIncrement,
                                  g_MultiplayerPainTweaks.m_ShotgunMinDamage );
    }
*/
}
...
xbool weapon_shotgun::FireNPCSecondaryProtected( const vector3& BaseVelocity , const vector3& Target , const guid& Owner, f32 fDegradeMultiplier, const xbool isHit  )
{
    ( void ) BaseVelocity;
    ( void ) Target;
    ( void ) Owner;
...
void weapon_shotgun::ProcessSfx( void )
{
/*
...
void weapon_shotgun::Reload( const ammo_priority& Priority )
{
...
xbool weapon_shotgun::ContinueReload( void )
{
...
//==============================================================================
xbool weapon_shotgun::CanFire( xbool bIsAltFire )
{
    s32 AmmoCount = 0;
...
xbool weapon_shotgun::GetFlashlightTransformInfo( matrix4& incMatrix, vector3& incVect )
{
...
xbool weapon_shotgun::OnProperty( prop_query& rPropQuery )
{
    if( new_weapon::OnProperty( rPropQuery ) )
    {
        ...
        if( GameMgr.IsGameMultiplayer() )
        {
            ...
            m_WeaponAmmo[ AMMO_PRIMARY ].m_AmmoAmount = 20;
