// LocoEditor.cpp : implementation file
//
...
IMPLEMENT_DYNCREATE(CLocoEditor_Frame, CBaseFrame)

CLocoEditor_Frame::CLocoEditor_Frame()
{
    m_Init = FALSE;
}
...
BEGIN_MESSAGE_MAP(CLocoEditor_Frame, CBaseFrame)
	//{{AFX_MSG_MAP(CLocoEditor_Frame)
	ON_WM_CREATE()
    ON_WM_DESTROY()
...
/////////////////////////////////////////////////////////////////////////////
// CLocoEditor_Frame message handlers

void CLocoEditor_Frame::ActivateFrame(int nCmdShow) 
{
...
int CLocoEditor_Frame::OnCreate(LPCREATESTRUCT lpCreateStruct) 
{
...
void CLocoEditor_Frame::OnDestroy( )
{
    // Save control bar postion.
    SaveBarState(_T("BarState - Loco"));
}

void CLocoEditor_Frame::OnSaveDesc() 
{
	// TODO: Add your command handler code here
	m_pDoc->Save();
}

void CLocoEditor_Frame::OnOpen() 
{
	// TODO: Add your command handler code here
	m_pDoc->Open();
}

void CLocoEditor_Frame::OnNewDesc() 
{
	// TODO: Add your command handler code here
	m_pDoc->New();
}

void CLocoEditor_Frame::OnClose() 
{
