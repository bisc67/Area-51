...
/////////////////////////////////////////////////////////////////////////////
// CDoubleBuffer
// See DoubleBuffer.cpp for the implementation of this class
//

class CDoubleBuffer
{
public:
                        CDoubleBuffer   ( CPaintDC*&    pDC );  // Construct double buffer
...
protected:
        CPaintDC*       m_pDC;                                  // Real DC that has been double buffered
