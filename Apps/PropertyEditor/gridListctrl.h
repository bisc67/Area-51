...
public:
    ...
    void SetBackgroundColor(COLORREF cr) { m_BackgroundColor = cr; }
...
protected:
    ...
    //see if the cursor is over the splitter
    BOOL HitTestOnSplitter( CPoint point );
    ...
    CPoint          m_SplitterDragStartPoint;
    int             m_SplitterDragStartWidth;
