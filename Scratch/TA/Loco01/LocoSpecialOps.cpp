...
xbool spec_ops_default::OnAdvance( f32 nSeconds )
{
    ...
    //    
    if( (m_Timer > 0.5f ) && (m_Base.m_Player.GetPosition() - m_Base.m_MoveAt).LengthSquared() > (80*80) )
    {
...
void spec_ops_default::OnEnter( void )
{
    ...
    m_Base.m_Player.SetAnimHoriz( "HSO_DEFAULT_IDLE" );
...
xbool spec_ops_run::OnAdvance( f32 nSeconds )
{
    ...
    locomotion::motion Motion = m_Base.ComputeMotion();
    {
        ...
        */
        ...
        if(  ( ( ( ( m_Base.m_Motion != locomotion::MOTION_TRANSITION ) && Motion != m_Base.m_Motion ) || 
          ...
          )
        {
            ...
            else
            {
                ...
                {
                case locomotion::MOTION_FORWARD:
                    m_Base.m_Player.SetAnimHoriz( "HSO_PROWL_FORWARD");//3translate forward with gun" );
                    m_Base.m_Motion = locomotion::MOTION_FORWARD;
                    //x_printf( "Move: F\n");
                    break;
                case locomotion::MOTION_LEFT:
                    m_Base.m_Player.SetAnimHoriz( "HSO_PROWL_STRAFE_L");//2translate left with gun" );
                    m_Base.m_Motion = locomotion::MOTION_LEFT;
                    //x_printf( "Move: L\n");
                    break;
                case locomotion::MOTION_RIGHT:
                    m_Base.m_Player.SetAnimHoriz( "HSO_PROWL_STRAFE_R");//translate right with gun" );
                    m_Base.m_Motion = locomotion::MOTION_RIGHT;
                    //x_printf( "Move: R\n");
                    break;
                case locomotion::MOTION_BACK:
                    m_Base.m_Player.SetAnimHoriz( "HSO_PROWL_BACKWARD");//2translate backward with gun" );
    ...
    m_Base.m_Player.SetYaw( m_Base.ComputeMoveDir() );
