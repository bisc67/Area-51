...
#include "Entropy.hpp"
//nclude "AsIs/MeshUtil/MeshViewer.hpp"
...
void Initialize( void )
{
    ...
    View.SetXFOV( R_60 );
    View.SetPosition( vector3( 200, 200, 400) );
//  View.SetPosition( vector3( 100, 100, 200) );
//  View.SetPosition( vector3(   5,   5,  10) );
    View.LookAtPoint( vector3(   0, 100,   0) );
...
//  MeshView.Load( "TrollholeWaterfall.MATX" );
    ...
    FXDebug.ElementWire   = 0;
    FXDebug.EffectAxis    = 0;
    FXDebug.EffectBounds  = 1;
    FXDebug.ElementBounds = 1;

    FXMgr.LoadEffect( "Test", "C:/Documents and Settings/mtraub/Documents/Effects/Test.fxo" );
//  FXMgr.LoadEffect( "Test", "C:/GameData/A51/Release/PC/dustmite_explode_000.fxo" );
...
//  FXHandle1.SetScale( vector3( 2.0f, 2.0f, 2.0f ) );

    FXHandle1.SetTranslation( vector3(  100, 0, 0 ) );
    FXHandle2.SetTranslation( vector3( -100, 0, 0 ) );
...
//      FXHandle2.AdvanceLogic( 1.0f / 150.0f );
//      FXHandle1.AdvanceLogic( 1.0f / 50.0f );
        FXHandle1.SetRotation( radian3( R_0, R_0, Rotate.ReadSec() * 0.25f ) );
